...
export default function Header() {
  ...
  return (
    ...
    {isTablet && <Box sx={{width:"82%", margin:"auto", marginTop: "10px", marginBottom: "10px",}} display="flex" justifyContent="space-between" alignItems="center">
                    <Typography alignItems="end" sx={{
                      color: theme.mainText,
                      fontWeight:"bold",
                      fontSize: "48px",
    ...
    {isMobile && <Box>
                  <Box sx={{width:"95%", margin:"auto", marginTop: "10px", marginBottom: "10px",}} display="flex" justifyContent="space-between" alignItems="center">
                    <Box sx={{cursor:"pointer",}}>
                      <AlignSvg><LogoFlox /></AlignSvg>
                    </Box>
                    <Box sx={{

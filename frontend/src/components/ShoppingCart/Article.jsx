    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Box>
            <Typography sx={{ color: theme.mainText, }}>{Article.article.name}</Typography>
            <Typography sx={{ color: theme.accentText, }}>
              {Article.article.seller_name}
            </Typography>
          </Box>
          <Typography sx={{ color: Article.amount > 0 ? "#808080" : "#FF2A2A", }}>
            {Article.amount > 0 ? inStockText : outOfStockText}
          </Typography>
          <Box sx={{ display: "flex" }}>
            <Box><img src="./images/icon_heart.svg" alt="" /></Box>
            <Box onClick={async () => {
